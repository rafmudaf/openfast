...
library_path = project_root + '/install/lib/libopenfastlib.so'
...
def openfoam(input_file_name):
    ...
    of = OF.OpenFastCoupled(input_file_name, 1, 0, 11., n_points_per_blade, n_points_tower, turbine_position, 0.5, rotor_area, air_density)
